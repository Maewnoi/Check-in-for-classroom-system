  ...
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      ...
      <a href="Home.php" class="w3-bar-item w3-button"><i class="fa fa-user"></i><?php echo $objResult["NAME"]; ?></a>
        <a href="Classroom.php" class="w3-bar-item w3-button">รายวิชา</a>
        <a href="subject.php" class="w3-bar-item w3-button">รายชื่อนักศึกษา</a> 
...
<br><br>
<div  align = "right">
<form method="get"> <input type="text" name="class_id">
